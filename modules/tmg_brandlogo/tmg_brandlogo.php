...
class Tmg_Brandlogo extends Module implements WidgetInterface
{
    protected $templateFile;

    public function __construct()
    {
        $this->name = 'tmg_brandlogo';
        ...
        $this->templateFile = 'module:tmg_brandlogo/views/templates/hook/tmg_brandlogo.tpl';
    }

    public function install()
    {
        Configuration::updateValue('TMG_BRAND_SLIDER', 1);
        Configuration::updateValue('TMG_BRAND_NAME', 0);
    ...
    public function uninstall()
    {
        return parent::uninstall()
            && Configuration::deleteByName('TMG_BRAND_SLIDER')
            && Configuration::deleteByName('TMG_BRAND_NAME');
    }
    ...
    public function getContent()
    {
        ...
        if (Tools::isSubmit('submitTmgBlockBrandLogos')) {
            
			Configuration::updateValue('TMG_BRAND_SLIDER', (int)(Tools::getValue('TMG_BRAND_SLIDER')));
			Configuration::updateValue('TMG_BRAND_NAME', (int)(Tools::getValue('TMG_BRAND_NAME')));
			$this->_clearCache('*');
    ...
    public function renderForm()
    {
        ...
        $helper->submit_action = 'submitTmgBlockBrandLogos';
    ...
    {
        return array(
            'TMG_BRAND_SLIDER' => (int)Tools::getValue('TMG_BRAND_SLIDER', Configuration::get('TMG_BRAND_SLIDER')),
            'TMG_BRAND_NAME' => (int)Tools::getValue('TMG_BRAND_NAME', Configuration::get('TMG_BRAND_NAME')),
        );
    }
    ...
    public function getWidgetVariables(
        ...
        return array(
            ...
            'slider' => Configuration::get('TMG_BRAND_SLIDER'),
			'brandname' => Configuration::get('TMG_BRAND_NAME'),
    ...
    public function renderWidget(
        ...
        $cacheId = $this->getCacheId('tmg_brandlogo');
