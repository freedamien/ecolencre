...
<div id="search_widget" class="col-lg-4 col-md-5 col-sm-12 search-widget dropdown js-dropdown" data-search-controller-url="{$search_controller_url}">
<div class="search-button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" role="button">
	<i class="material-icons search">&#xE8B6;</i> 
	<i class="material-icons clear">&#xE14C;</i>
</div>
	<form class="search-box dropdown-menu" method="get" action="{$search_controller_url}">
