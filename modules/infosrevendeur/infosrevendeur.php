...
require_once(dirname(__FILE__).'/classes/InfosRevendeurClass.php');

class InfosRevendeur extends Module
{
	public function __construct()
	{
		$this->name = 'infosrevendeur';
...
//Pensez systématiquement à faire une fonction de désinstallation
  ...
  public function uninstall()
    ...
    {
        $myInfos = InfosRevendeurClass::getRevendeurDonnees((int)$id_cms);
