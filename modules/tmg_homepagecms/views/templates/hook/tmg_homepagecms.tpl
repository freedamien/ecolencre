...
<div id="tmghomepagecms">
  {if $tmgcms_infos.text == 'add your code here'}
		<div class="container">
			<div class="row">
				<div class="subbannercms2">
				<div class="subbanner blocks">
				<div class="subbanner-inner">
					<div class="subbanner-image">
					<a class="subbanner-image" href="#">
					<img src="modules/tmg_homepagecms/views/img/subbanner2.jpg" alt="banner2.jpg">
					</a>
					</div>
					<div class="detailes">
					<div class="cms-icon"><img src="modules/tmg_homepagecms/views/img/game.png" alt="game.png"></div>
					<div class="top-title">up to 30% off all products</div>
					<div class="title">Best 3D vr box</div>
