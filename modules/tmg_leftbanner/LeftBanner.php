...
class LeftBanner extends ObjectModel
{
	...
	public static $definition = array(
		'table' => 'tmgleftbanner_slides',
		'primary' => 'id_tmgleftbanner_slides',
		'multilang' => true,
		'fields' => array(
	...
	public function add($autodate = true, $null_values = false)
	{
		...
		$res &= Db::getInstance()->execute('
			INSERT INTO `'._DB_PREFIX_.'tmgleftbanner` (`id_shop`, `id_tmgleftbanner_slides`)
	...
	public function delete()
	{
		...
		$res &= Db::getInstance()->execute('
			DELETE FROM `'._DB_PREFIX_.'tmgleftbanner`
			WHERE `id_tmgleftbanner_slides` = '.(int)$this->id
		);
	...
	public function reOrderPositions()
	{
		...
		$max = Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
			...
			WHERE hss.`id_tmgleftbanner_slides` = hs.`id_tmgleftbanner_slides` AND hs.`id_shop` = '.(int)$id_shop
		);
		...
		$rows = Db::getInstance(_PS_USE_SQL_SLAVE_)->executeS('
			SELECT hss.`position` as position, hss.`id_tmgleftbanner_slides` as id_slide
			FROM `'._DB_PREFIX_.'tmgleftbanner_slides` hss
			LEFT JOIN `'._DB_PREFIX_.'tmgleftbanner` hs ON (hss.`id_tmgleftbanner_slides` = hs.`id_tmgleftbanner_slides`)
